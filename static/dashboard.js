...
function render() {
  ...
  <div class="upload-card">
    ...
    <a href="/download/${u.filename}" style="background-color: transparent;">
      <button style="background-color: #0d6efd;">Download</button>
    </a>
    ...
    ${
      ...
      <button onclick="deleteFile(${u.id})" style="background-color: #f72119;">Delete</button>
      ` : ""
    }
  </div>
  `;
